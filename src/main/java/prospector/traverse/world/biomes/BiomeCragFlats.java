...
public class BiomeIcyFlats extends Biome implements ITreeConstants {
    ...
    public static BiomeProperties properties = new BiomeProperties("Icy Flats");
